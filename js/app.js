const App = {
    ...
    getMayaContent() {
        return {
            main: {
                ...
                perfil: "Perfil",
                perfilInfo: "Información personal"
            }
        };
    },
            ...
            return `
                <div class="instructions-screen">
                    <div class="header-blue">
                        <div class="header-with-back">
                            ...
                            <div class="header-text">
                                <h2>Meyajilo'ob tu yóok'ol kaaj</h2>
                                <p>Meyajilo'ob tu yóok'ol kaaj</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="oficial-link">
                        <a href="#" onclick="window.app.openOfficialSite('capa')" class="btn-oficial">🌐 Okol ti' le sitio oficial CAPA →</a>
                    </div>
                    ...
                    <div class="oficial-link">
                        <a href="#" onclick="window.app.openOfficialSite('cfe')" class="btn-oficial">🌐 Okol ti' le sitio oficial →</a>
                    </div>
                </div>
            `;
        }
    ...
    render() {
        ...
        if (this.currentLanguage === 'maya') {
            ...
            } else if (this.currentScreen === 'perfil') {
    ...
    renderTramiteDetail() {
        ...
        // MODO TEXTO GRANDE - CURP (SIN CAMBIOS)
        ...
        // MODO TEXTO GRANDE - RFC (SIN CAMBIOS)
        ...
        // MODO TEXTO GRANDE - ACTA (SIN CAMBIOS)
        ...
        if (this.accessibilityMode === 'large-text' && this.selectedTramite === 'servicios') {
            ...
            return `
                <div class="instructions-screen">
                    ...
                    <div class="oficial-link">
                        <a href="#" onclick="window.app.openOfficialSite('capa')" class="btn-oficial">🌐 Ir al sitio oficial de CAPA →</a>
                    </div>
                    ...
                    <div class="oficial-link">
                        <a href="#" onclick="window.app.openOfficialSite('cfe')" class="btn-oficial">🌐 Ir al sitio oficial →</a>
                    </div>
                </div>
            `;
        }
    ...
    renderPerfil() {
        ...
        return `
            ...
            <div class="profile-card">
                ...
                <h3>${user?.full_name || 'Alfredo'}</h3>
                <p>📧 ${user?.email || 'tuzdzidzv@gmail.com'}</p>
            </div>
